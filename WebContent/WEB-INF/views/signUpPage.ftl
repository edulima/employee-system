                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Sign-up to access have full access</h3>
                        		</div>
                            </div>
                            <div class="form-bottom">
			                    <form role="form" action="" method="post" class="login-form">
			                        ...
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-re-enter-password">Password</label>
			                        	<input type="password" name="form-password-re-enter-password" placeholder="Re-enter password..." class="form-re-enter-password form-control" id="form-re-enter-password">
			                        </div>
			                        <button type="submit" class="btn">Sign-up</button>
			                        <p class="text-right"><a href="login_page.mvc">Login page</a><p>
			                    </form>
		                    </div>
                        </div>
                    </div>                 
